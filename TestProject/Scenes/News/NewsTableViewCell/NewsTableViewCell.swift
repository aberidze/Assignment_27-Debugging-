...
// FIXME: უნდა იყოს არა UICollectionViewCell-ის, არამედ UITableViewCell-ის შვილობილი
final class NewsTableViewCell: UITableViewCell {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            // FIXME: შეცდომები ქონსთრეინთებში
    ...
    // MARK: - Configure
    // FIXME: Private func იყო და შეცდომაა, რადგან NewsViewController-დან ვერ ხერხდებოდა მასზე წვდომა.
